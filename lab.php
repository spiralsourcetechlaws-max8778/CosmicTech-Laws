...
$payload_module_available = false;
$payload_module = null;
...
$lab_tools = [
    'payload_tester' => [
        ...
        'status' => $payload_module_available ? 'active' : 'inactive'
    ],
    'network_simulator' => [
...
<body>
    ...
    <div class="lab-stats">
        ...
        <div class="stat-card">
            <div style="color: var(--lab-purple); font-size: 1.2em; font-weight: bold;">
                <?php echo $payload_module_available ? '✅' : '❌'; ?>
            </div>
            <div style="color: #ccc; font-size: 0.9em;">Payload Module</div>
        </div>
        <div class="stat-card">
            <div style="color: var(--lab-green); font-size: 1.2em; font-weight: bold;">
                ISOLATED
    ...
    <div class="test-panel">
        ...
        <?php if ($payload_module_available): ?>
